...
schemas = BaseTool().multiple_functions_to_dict(tools)
...
async def main():
    async with SwarmsClient() as client:
        ...
        response = await client.agent.acreate(
            agent_config={
                "agent_name": "CryptoQuant",
                "model_name": "gpt-4o-mini",
                "description": "A quantitative analysis agent that analyzes cryptocurrency market data and sentiment",
                "system_prompt": "You are a quantitative analysis agent that analyzes cryptocurrency market data and sentiment. Use the available tools to gather market data and provide insights.",
                "role": "quant",
                "tools_list_dictionary": schemas,
                "max_loops": 1,
                "temperature": 0.7,
            },
            task="Analyze the current market sentiment and price trends for Bitcoin and Ethereum",
        )
