...
class TestClient:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_root(self, client: Swarms) -> None:
        client_ = client.get_root()
        assert_matches_type(object, client_, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_get_root(self, client: Swarms) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_get_root(self, client: Swarms) -> None:
...
class TestAsyncClient:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_root(self, async_client: AsyncSwarms) -> None:
        client = await async_client.get_root()
        assert_matches_type(object, client, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_get_root(self, async_client: AsyncSwarms) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_get_root(self, async_client: AsyncSwarms) -> None:
